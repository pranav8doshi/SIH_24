...
const positions = [[-768,250,0], [768,250,0]]
...
function animate() {
    ...
    asteroids.forEach( (asteroid) => {
        ...
        if(x < 0 && asteroid.mesh.position.x != -1.5772209563332797)
        {
            asteroid.mesh.position.x = x + 0.025;
            console.log(asteroid.mesh.position.x)
        }
        else if(x > 0 && asteroid.mesh.position.x != 1.5772209563332797) 
            asteroid.mesh.position.x = x - 0.025;
        else if(!flag)
        {
            alert(`${asteroids[0].name} is going to collide with ${asteroids[1].name} `);
            flag = true;
            arrowHelper.position.set(-1.2872209563332797,1.5772209563332797,-0.5);
