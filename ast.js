...
for (let i = 0; i < numAsteroids; i++) {
    const ast_gem = new THREE.IcosahedronGeometry(0.025, 1);
...
function onMouseMove(event) {
    ...
    if (intersects.length > 0) {
        ...
        tooltip.innerHTML = `Name: Asteroid<br>Latitude: ${asteroidData.latitude.toFixed(2)}<br>Longitude: ${asteroidData.longitude.toFixed(2)}`;
